        ...
        switch (item.getItemId()) {
            case R.id.nav_camera:
              ...
              //  displayToast(getString(R.string.chose_camera));
                ...
                Snackbar recent = Snackbar.make( drawer, R.string.chose_camera, Snackbar.LENGTH_LONG)
                        .setAction("Close", new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                drawer.closeDrawer(GravityCompat.START);
                                displayToast("Recents Closed");
                            }
                        }); {
            ...
            case R.id.nav_gallery:
               ...
               // displayToast(getString(R.string.chose_gallery));
                ...
                Snackbar contacts = Snackbar.make( drawer,R.string.chose_gallery, Snackbar.LENGTH_LONG)
                        .setAction("Close", new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                drawer.closeDrawer(GravityCompat.START);
                                displayToast("Contacts Closed");
                            }
                        }); {
                // Responds to click on the action
                contacts.show();
            ...
            case R.id.nav_slideshow:
              ...
              //  displayToast(getString(R.string.chose_slideshow));
                ...
                Snackbar calendar = Snackbar.make( drawer, getString(R.string.chose_slideshow), Snackbar.LENGTH_LONG)
                        .setAction("Close", new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                drawer.closeDrawer(GravityCompat.START);
                                displayToast("Calendar Closed");
                            }
                        }); {
                // Responds to click on the action
                calendar.show();
            ...
            case R.id.nav_manage:
               ...
               // drawer.closeDrawer(GravityCompat.START);
                ...
                Snackbar tools = Snackbar.make( drawer, R.string.chose_tools, Snackbar.LENGTH_LONG)
                        .setAction("Close", new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                drawer.closeDrawer(GravityCompat.START);
                                displayToast("Preference Closed");
                            }
                        }); {
                // Responds to click on the action
                tools.show();
            ...
            case R.id.nav_share:
               ...
               // drawer.closeDrawer(GravityCompat.START);
                ...
                Snackbar share = Snackbar.make( drawer, R.string.chose_share, Snackbar.LENGTH_LONG)
                        .setAction("Close", new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                drawer.closeDrawer(GravityCompat.START);
                                displayToast("Share Contact Closed");
                            }
                        }); {
                // Responds to click on the action
                share.show();
            ...
            case R.id.nav_send:
             ...
             //   displayToast(getString(R.string.chose_send));
                Snackbar send = Snackbar.make( drawer, R.string.chose_send, Snackbar.LENGTH_LONG)
                        .setAction("Close", new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                 drawer.closeDrawer(GravityCompat.START);
                                 displayToast(" Send Email Closed");
                            }
                        }); {
                // Responds to click on the action
                send.show();
